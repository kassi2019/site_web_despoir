<template>
  <div>
    <div class="image-text-container ombre41" style="">
      <img src="img/hero.jpg" alt="Image" />
      <div class="text-content">
        <h1 class="mb-3" style="color: #fff !important; text-align: center">
          Enseignement
        </h1>
        <p style="color: #fff !important; font-size: 20px !important">
          Despoir au service des établissements scolaires Notre mission :
        </p>
        <p style="color: #fff !important; font-size: 20px !important">
          offrir aux jeunes générations une pause déjeuner à la fois conviviale
          et équilibrée, tout en leur transmettant le plaisir d’une alimentation
          saine et durable.
        </p>
      </div>
    </div>
